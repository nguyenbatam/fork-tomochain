...
import (
	...
	"github.com/fns/fns/internal/jsre"
	"github.com/fns/fns/internal/web3ext"
...
func (c *Console) Welcome() {
	// Print some generic FNS metadata
	fmt.Fprintf(c.printer, "Welcome to the FNS JavaScript console!\n\n")
	c.jsre.Run(`
